...
// Helpers
    ...
    // Extensions
    std::vector<const char*> Renderer::Device::getRequiredExtensions() const
    {
...
// Components
    ...
    // Instance
    void Renderer::Device::createVulkanInstance()
    {
    ...
    // Debug messenger
    void Renderer::Device::setupDebugMessanger()
    {
    ...
    bool Renderer::Device::checkValidationLayerSupport() const
    {
        uint32_t layerCount;
    ...
    // Physical Device
    void Renderer::Device::PickPhysicalDevice()
    {
